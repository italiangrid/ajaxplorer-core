...
"144"=> "Not logged in.",
"145"=> "Set this folder as my home",
"146"=> "Delete Bookmark",
"147"=> "Bookmarks", 
"148"=> "Parent", 
"149"=> "Refresh",
...
"446" => "More Info",
"449" => "Shared",
"450" => "Drag'n'drop users to give or revoke ACL on the file/folder",
"451" => "Set Home",
"452" => "If the files will be successfully downloaded, you will find them in My Files repository (dropdown menu on the left)."
);
?>
