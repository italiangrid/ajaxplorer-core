...
"440" => "Yes",
"441" => "No",
"442" => "Get more info on selected item",
"445" => "Replicate",
"446" => "More Info",
"447" => "Share",
"448" => "Manage file replicas among SEs",
"449" => "Shared with",
"450" => "Item shared with:",
"451" => "Set as Home",
//"452" => "If the files will be correctly downloaded, you will find them in My Files repository (dropdown menu on the left)."
"452" => "Save a copy on Portal repository (dropdown menu on the left).",
//"452" => "The selected files will be saved on your PC.",
"453" => "Copy to Grid",
"454" => "Drag'n'drop Grid SEs to add or delete file on them",
"455" => "Grid SEs available",
"456" => "More",
"457" => "Grid SEs already hosting the file",
"458" => "Select the repository"
);
?>
